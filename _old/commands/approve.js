...
module.exports = {
	...
	execute(message, args, cmd, client, discord) {
        ...
        .then(msg => {
            ...
            .setColor('#0f6409')
            .setAuthor('Approved Suggestion', 'https://i.imgur.com/L0mPlDU.png')
            .setTitle(msg.embeds[0].title)
            .setDescription(msg.embeds[0].description)
            .setThumbnail(msg.embeds[0].thumbnail.url)
            .addFields(
            	{ name: `Approved by ${message.author.tag}`, value: args.slice(1).join(' ') }
            )
            .setTimestamp()
        ...
        if(args.length == 3 || args === undefined) {
            ...
            editEmbed()
            message.channel.send('<:checkmark:978551077899214908> Successfully approved the message.')
        } else {
